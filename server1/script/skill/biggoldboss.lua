...
SKILLS={
	...
	wulei_zhengfa={ --五雷正法
		...
		liushui2={--流水2（绝学）
		fastwalkrun_p={{{1,5},{20,33}},{{1,18},{2,18}}},--降低一半移动速度
		anti_block_rate={{{1,1},{20,600},{21,600}},{{1,18},{2,18}}},
		block_rate={{{1,1},{10,50},{11,50} },{{1,18},{2,18}}},
		anti_allres_yan_p={{{1,1},{20,450},{21,450}},{{1,18},{2,18}}},
		fatallystrikeres_p={{{1,1},{20,100}},{{1,18},{2,18}}},
		--enhancehit_rate={{{1,150},{2,150}},{{1,-1},{20,-1}}},
},
		bangda_egou1={ --棒打恶狗
		physicsdamage_v={
