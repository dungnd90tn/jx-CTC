...
SKILLS={
	...
	{ --春牛专用必杀技子技能
		...
		firedamage_v=
		{
			[1]={{1,2000},{20,40000*1000}},
			[3]={{1,2000},{20,40000*1000}}
		},
		poisondamage_v=
		{
			[1]={{1,20},{20,1600*1000}},
	...
	niumowang={ --牛魔王光环
		lifemax_v={{{1,50000},{20,1000000}},{{1,18*2},{2,18*2}}},
		manamax_v={{{1,50000},{20,1000000}},{{1,18*2},{2,18*2}}},
		lifereplenish_v={{{1,25000},{20,500000}},{{1,18*2},{2,18*2}}},
		manareplenish_v={{{1,25000},{20,500000}},{{1,18*2},{2,18*2}}},
		fasthitrecover_v={{{1,90},{20,100},{31,200},{32,200}},{{1,18*2},{2,18*2}}},
		fatallystrikeres_p={{{1,90},{20,100}},{{1,18*2},{2,18*2}}},
		freezetimereduce_p={{{1,90},{20,100}},{{1,18*2},{2,18*2}}},
		poisontimereduce_p={{{1,90},{20,100}},{{1,18*2},{2,18*2}}},
		stuntimereduce_p={{{1,90},{20,100}},{{1,18*2},{2,18*2}}},
		addphysicsmagic_v={{{1,100},{20,1000}},{{1,18*2},{2,18*2}}},
		addphysicsdamage_v={{{1,100},{20,1000}},{{1,18*2},{2,18*2}}},
		allres_p={{{1,50},{20,100}},{{1,18*2},{2,18*2}}},
		allresmax_p={{{1,5},{20,10},{21,10}},{{1,18*2},{2,18*2}}},
		fastwalkrun_p={{{1,1000},{20,20000}},{{1,18*2},{2,18*2}}},
		attackspeed_v={{{1,1000},{20,20000}},{{1,18*2},{20,18*2}}},
		castspeed_v={{{1,1000},{20,20000}},{{1,18*2},{20,18*2}}},
		staminareplenish_v={{{1,10000},{20,200000}},{{1,18*2},{2,18*2}}},
		returnres_p={{{1,100},{20,2000}},{{1,18*2},{2,18*2}}},
	},
	mengniu={ --猛牛光环
